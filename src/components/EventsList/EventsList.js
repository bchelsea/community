...
const  EventsList = (props) => {
    return (
        ...
        <p className='event-details'><b>Details:</b> Dragon Dancing has never been more fun when your life is on the line!<br/>
        ...
        <p className='event-details'><b>Details:</b> Can you name a better combo? come celebrate Humpday with the ladies while we 
        ...
        <p className='event-details'><b>Details:</b>What is Art? Who does Art? Well come find out while we celebrate the talented Artists of our town!
        ...
        <p className='event-details'><b>Details:</b> Having a wedding? Want to learn more about how to make your wedding the best as well as most cost effective? 
        ...
        <p className='event-details'><b>Details:</b> The Best time of the year is here people, Come hang out while enjoying the flavors of the best
        burgers in town! <br/>
        ...
        <p className='event-details'><b>Details:</b> Just in time for Halloween, and so the aliens don't get ya! come learn how to make one of your
